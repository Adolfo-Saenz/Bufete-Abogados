...
<div class="max-w-4xl mx-auto px-4 py-10 grid grid-cols-1 md:grid-cols-2 gap-10">
  ...
  <div>
    ...
    <?php if(!is_user_logged_in()): ?>
      ...
      <?php endif; ?>
      <form method="post" action="<?php echo e(wp_login_url(home_url())); ?>" class="space-y-4">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\adolfo.saenz\Local Sites\bufete-abogados\app\public\wp-content\themes\bufete-theme\resources\views/page-formulario-de-registro.blade.php ENDPATH**/ ?>