...
<section class="h-[80px] bg-[#232536] px-5">
    <div class="flex items-center justify-between h-[80px]">
        ...
        <div class="flex items-center space-x-15 max-lg:space-x-2">
            ...
            <a href="<?php echo e(is_user_logged_in() ? 'http://bufete-abogados.local/users-page/' : "http://bufete-abogados.local/formulario-de-registro/"); ?>" class="h-[50px] w-[150px] max-md:w-[130px] bg-white text-[#1e1f36] font-bold rounded-md hover:scale-105 transition-transform duration-200 flex items-center justify-center">
                Área de clientes
            </a>
        </div>
    </div>
</section><?php /**PATH C:\Users\adolfo.saenz\Local Sites\bufete-abogados\app\public\wp-content\themes\bufete-theme\resources\views/partials/organisms/organism-header.blade.php ENDPATH**/ ?>