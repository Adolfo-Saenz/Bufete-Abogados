    ...
    <div class="lg:h-[500px] w-full md:w-3/5 h-responsive max-lg:mt-10">
        <div class="flex lg:flex-row flex-col items-center lg:ml-10 lg:my-25">
            ...
            <div class="max-lg:flex max-lg:flex-col max-lg:items-center max-lg:text-center">
                ...
                <a href="<?php echo e("http://bufete-abogados.local/wp-admin/profile.php"); ?>" class="boton text-[20px] lg:ml-12 mt-10 lg:mb-0 mb-7 [width:186px] [height:65px] flex items-center justify-center bg-white text-[#232536] rounded-[10px] font-bold font-sans hover:scale-105 transition-transform duration-200">
                    Editar perfil
                </a>
            </div>
        </div>
